...
export default function PiscalContactPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white font-sans text-gray-800">
      ...
      <div className="relative overflow-hidden rounded-b-3xl shadow-xl mb-16">
        <div className="flex flex-row">
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-12 w-1/2 flex flex-col justify-center relative z-10">
            <h1 className="text-4xl font-bold mb-6 text-gray-800">Contact our team</h1>
          ...
          <div className="w-1/2 relative">
            ...
            <img src="/video.png" alt="Woman working on laptop with coffee" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-8 max-w-5xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-10 text-center">
          <h2 className="text-2xl font-bold mb-6">Already a Piscal+ client?</h2>
          <p className="mb-3 text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-white hover:bg-gray-50 border-2 border-gray-800 rounded-full px-8 py-3 font-medium transition-all">
              Appointment Centre
            </button>
            <button className="bg-white hover:bg-gray-50 border-2 border-gray-800 rounded-full px-8 py-3 font-medium transition-all">
              Help Center
      ...
      <div className="py-16 px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">We're here for your real estate needs</h2>
          <p className="text-gray-600 text-lg">Directly contact the team that can help you.</p>
        </div>
        
        <div className="flex flex-row gap-6 mx-auto max-w-6xl">
          {/* Property Sale */}
          <div className="bg-white p-8 rounded-2xl shadow-lg flex-1 text-left transform hover:translate-y-1 transition-all border-t-4 border-green-500">
            ...
            <h3 className="text-xl font-bold mb-3">Property sale</h3>
          ...
          {/* Property Rental */}
          <div className="bg-white p-8 rounded-2xl shadow-lg flex-1 text-left transform hover:translate-y-1 transition-all border-t-4 border-blue-500">
            <div className="flex justify-center mb-6">
              <div className="text-blue-500 bg-blue-50 p-4 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                  <polyline points="9 22 9 12 15 12 15 22"></polyline>
                </svg>
            ...
            <h3 className="text-xl font-bold mb-3">Property rental</h3>
            <p className="text-gray-600 mb-6">
          ...
          {/* Business Services */}
          <div className="bg-white p-8 rounded-2xl shadow-lg flex-1 text-left transform hover:translate-y-1 transition-all border-t-4 border-purple-500">
            <div className="flex justify-center mb-6">
              <div className="text-purple-500 bg-purple-50 p-4 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="py-16 px-8 max-w-6xl mx-auto">
        <div className="flex flex-row gap-8 bg-white rounded-2xl shadow-lg overflow-hidden">
          {/* Contact Form */}
          <div className="w-7/12 p-10">
            <h2 className="text-2xl font-bold mb-4">Contact us by e-mail</h2>
            ...
            <form className="mt-6">
              ...
              <div className="mb-5">
                ...
                <textarea
                  className="w-full p-3 border border-gray-300 rounded-lg h-32 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
                  required
                ></textarea>
              </div>
              ...
              <div className="mb-6 bg-gray-50 p-4 rounded-lg">
                <p className="font-medium text-sm mb-2">Stay up-to-date!</p>
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-green-600 to-green-500 text-white py-3 px-8 rounded-lg w-full font-medium hover:from-green-700 hover:to-green-600 transition-all shadow-md"
              >
                Submit
              </button>
            </form>
          ...
          {/* Head Office */}
          <div className="w-5/12 bg-gradient-to-br from-gray-800 to-gray-900 text-white p-10 flex flex-col justify-center">
            <h2 className="text-2xl font-bold mb-6">Head office</h2>
            <p className="mb-1 text-gray-300">Our offices are not open to the public.</p>
            <p className="mb-8 text-gray-300">Please contact us by mail or fax.</p>
            
            <div className="bg-gray-700 bg-opacity-40 p-6 rounded-xl mb-8">
              <address className="not-italic mb-0 text-gray-200">
            ...
            <div className="flex items-center text-green-300">
              ...
              <span className="text-xl">1-866-832-2066</span>
            </div>
          </div>
        </div>
      </div>
